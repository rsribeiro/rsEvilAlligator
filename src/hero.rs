...
const HERO_HORIZONTAL_SPEED: f32 = 0.25;
const HERO_VERTICAL_SPEED: f32 = 0.2;
const HERO_INITIAL_LIVES: i32 = 5;
const TOTAL_BLINK_TIME: f64 = 2000.;
const BLINK_INTERVAL: f64 = 200.;
const HERO_FEET_HEIGHT: f32 = 10.;
...
pub fn get_hero_body_feet_area(self_area: Rectangle) -> (Rectangle, Rectangle) {
    (
        Rectangle::new(
            self_area.top_left(),
